...
export let renderView: boolean = false;
...
export class LAppDelegate {
  ...
  public setRenderView(renderViewNew: boolean): void {
    renderView = renderViewNew;
  }

  public setSessionToken(session_token_new: string): void {

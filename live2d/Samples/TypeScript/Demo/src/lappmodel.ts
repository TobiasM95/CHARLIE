...
export class LAppModel extends CubismUserModel {
  ...
  public update(): void {
    ...
    if (this._motionManager.isFinished()) {
      ...
      if (this._idleMotionCooldownCurrent < this._idleMotionCooldown) {
        this._idleMotionCooldownCurrent += deltaTimeSeconds;
      }
      else {
        this._idleMotionCooldownCurrent = 0;

        // based on subjective selection criterias
        // const validIdleMotionIndices: Array<number> = [0, 1, 2];

        // const no: number = Math.floor(
        //   Math.random() * validIdleMotionIndices.length
        // );

        console.log("Start idle motion");
        // this.startMotion(
        //   LAppDefine.MotionGroupIdle,
        //   validIdleMotionIndices[no],
        //   LAppDefine.PriorityIdle
        // );
        this.startRandomMotion(
          LAppDefine.MotionGroupIdle,
    ...
    if (this._lipsync) {
      ...
      // console.log(this._userTimeSeconds, value)
  ...
  _idleMotionCooldown: number;
  _idleMotionCooldownCurrent: number;
}
